...
class HolidayInfoComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextStyle contentTextStyle = Theme.of(context).textTheme.bodyMedium!.copyWith(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Text("$year", style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                    fontWeight: FontWeight.bold,
                    fontSize: 20
                  )),
                ],
              ...
              Row(
                children: [
                  Text("총 휴일 수 : ", style: contentTextStyle,),
                  Text(
              ...
              Row(
                children: [
                  Text("주말을 제외한 휴일 수 : ", style: contentTextStyle,),
                  Text(holidayList.toWithoutWeekend().length.toString())
                ],
              ),
              Row(
                children: [
                  Text("남은 휴일 수 : ", style: contentTextStyle,),
                  Text(holidayList
                      .toWithoutWeekend()
                      .toRemainingList()
                      .length
